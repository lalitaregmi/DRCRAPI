...
namespace Helper.Dapper
{
    public class NepDateConverter
    {
        ...
        private static void InitializeData()
        {
            ...
            months.Add(01, "Baishak");
            months.Add(02, "Jestha");
            months.Add(03, "Ashad");
            months.Add(04, "Shrawn");
            months.Add(05, "Bhadra");
            months.Add(06, "Ashwin");
            months.Add(07, "kartik");
            months.Add(08, "Mangshir");
            months.Add(09, "Poush");
            months.Add(10, "Magh");
        ...
        public static DateTime NepToEng(string nepdate)
        {
            NepDate dateTime = new NepDate();
            dateTime.Year = Int32.Parse(nepdate.Substring(1, 4));
            dateTime.Month = Int32.Parse(nepdate.Substring(6, 2));
            dateTime.Day = Int32.Parse(nepdate.Substring(9, 2));
